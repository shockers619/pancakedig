          ...
          <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: '440px' }}>
            ...
            {submitted ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <p style={{ fontSize: '13px', color: 'var(--chalk-dim)', lineHeight: 1.5, margin: 0 }}>
                  Are you affiliated with this club, event, or organization? Submit a claim and we’ll review it — once approved, you can edit this listing directly.
                </p>
                <div>
